...
int main() {
    ...
    int secim;
    cout << "\n------------------Menu------------------\n";
    cout << "Ogrenci numarasina gore arama yapmak icin 1\n";
    cout << "Ogrenci ortalamasina gore siralama yapmak icin 2\n";
    cout << "Tum ogrencilerin not ortalamasini hesaplamak icin 3\n";
    cout << "Seciminiz: ";
    cin >> secim;
